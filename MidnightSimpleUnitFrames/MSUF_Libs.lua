...
-- -----------------------------------------------------------------------------
-- RangeCheck (LibRangeCheck)
-- Used by Range Fade (Target/Focus) when enabled.
-- NOTE: This must be a no-op unless someone asks for the lib, so callers can
-- safely keep the function reference even when the feature is disabled.
-- -----------------------------------------------------------------------------
