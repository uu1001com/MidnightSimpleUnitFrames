...
if _G and _G.MSUF_Search_RegisterRoots then
    ...
    local boldCheck = MakeCheck("MSUF_BoldTextCheck", right, L["Use bold text (THICKOUTLINE)"], nil, R_CHECK_TW)
    local noOutlineCheck = MakeCheck("MSUF_NoOutlineCheck", right, L["Disable black outline around text"], nil, R_CHECK_TW)
    local textBackdropCheck = MakeCheck("MSUF_TextBackdropCheck", right, L["Add text shadow (backdrop)"], nil, R_CHECK_TW)
    ...
    local nameClassColorCheck = MakeCheck("MSUF_NameClassColorCheck", right, L["Color player names by class"], nil, R_CHECK_TW)
    local npcNameRedCheck = MakeCheck("MSUF_NPCNameRedCheck", right, L["Color NPC/boss names using NPC colors"], nil, R_CHECK_TW)
    local powerTextColorByTypeCheck = MakeCheck("MSUF_PowerTextColorByTypeCheck", right, L["Color power text by power type"], nil, R_CHECK_TW)
    ...
    local shortenNamesCheck = MakeCheck("MSUF_ShortenNamesCheck", right, L["Shorten unit names (except Player)"], nil, R_CHECK_TW)
